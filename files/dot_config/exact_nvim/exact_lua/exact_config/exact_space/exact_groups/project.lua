...
vim.keymap.set('n', '<Leader>pf', '<Cmd>Telescope find_files layout_strategy=ivy_hermit<CR>', { desc = 'Find file' })
...
vim.keymap.set('n', '<Leader>pr', function() require('telescope.builtin').oldfiles({ layout_strategy = 'ivy_hermit', only_cwd = true }) end, { desc = 'Open a recent file' })
